...
// #define PRINT_HTTP
    ...
    private:
        ...
        int getHTTPResponse(String & response)
        {
            ...
            #if !(defined(ARDUINO_NANO_RP2040_CONNECT) && !defined(USE_MBEDRTOS))
            // Usage of millis on the RP2040 connect with baremetal scheduler is causing issues
        ...
        int convertFloatToChar(float value, char *valueString)
        {
            ...
            #if defined(ARDUINO_ARCH_SAMD) || defined(ARDUINO_ARCH_SAM) || defined(ARDUINO_NANO_RP2040_CONNECT)
