...
/* This will be run in Rapid Accelerator Mode */
    ...
    #define MW_readAllFieldsAsFloat(a,b,c,d,e,f) (0)
#else
        ...
        void MW_readAllFieldsAsFloat(unsigned long channelNumber, const char * readAPIKey, float *data, uint8_T *fields, unsigned int nFields, int16_t *status);
