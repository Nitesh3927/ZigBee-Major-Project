...
#define CUSTOM_STRING_MAX_SIZE 50
...
static void esp_zb_buttons_handler(switch_func_pair_t *button_func_pair)
{
    if (button_func_pair->func == SWITCH_ONOFF_TOGGLE_CONTROL) {
        ...
        while(true) {
            i2c_slave_read_buffer(I2C_NUM_0, value, sizeof(value) - 8, 10 / portTICK_PERIOD_MS);
            value[48] = 'E';
            value[49] = 'D';
            ...
            ESP_LOGI(TAG, "Send 'write large data(%d)' command\n", sizeof(value));
